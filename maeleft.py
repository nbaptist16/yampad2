...
# # servo.setAccel(2,4)      #set servo 0 acceleration to 4
# # servo.setTarget(2,5000)  #set servo to move to center position

# # servo.setAccel(4,4)      #set servo 0 acceleration to 4
# # servo.setTarget(4,5000)  #set servo to move to center position

# # servo.setAccel(6,4)      #set servo 0 acceleration to 4
# # servo.setTarget(6,5000)  #set servo to move to center position

# # # servo.setAccel(8,4)      #set servo 0 acceleration to 4
# # # servo.setTarget(8,5000)  #set servo to move to center position
# # servo.setAccel(8,4)      #set servo 0 acceleration to 4
# # servo.setTarget(8,5000)  #set servo to move to center position
...
servo.setAccel(6,4)      #set servo 0 acceleration to 4
servo.setTarget(6,-1)  #set servo to move to center position
